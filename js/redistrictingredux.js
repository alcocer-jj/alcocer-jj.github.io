// =============================================================
// redistricting_map_standalone.js  —  Alcocer, Grose & McKee (2026)
// Standalone version: map initialises automatically on page load.
...
(function () {
  ...
  // On the standalone page the map is always visible — no toggle button needed.
  // We initialise directly on DOMContentLoaded and invalidate size shortly after
  // to ensure Leaflet renders correctly once the layout has settled.
